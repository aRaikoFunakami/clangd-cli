...
allowed-tools: Bash(clangd-cli *), Bash(clangd-cli * 2>/dev/null), Bash(clangd-cli *|jq *), Bash(clangd-cli * 2>/dev/null|jq *), Bash(clangd-cli *| jq *), Bash(clangd-cli * 2>/dev/null | jq *), Bash(clangd-cli *|head *), Bash(clangd-cli * 2>/dev/null|head *), Bash(clangd-cli *| head *), Bash(clangd-cli * 2>/dev/null | head *), Bash(clangd-cli *|grep *), Bash(clangd-cli * 2>/dev/null|grep *), Bash(clangd-cli *| grep *), Bash(clangd-cli * 2>/dev/null | grep *), Bash(jq *), Bash(date *), Bash(cat *), Bash(echo *)
---
